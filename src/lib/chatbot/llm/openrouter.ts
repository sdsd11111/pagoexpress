// ═══════════════════════════════════════════════════════════════
// PagoExpress Elite Chatbot — OpenRouter LLM Provider (Fallback)
// ═══════════════════════════════════════════════════════════════
...
function getClient(): OpenAI {
    if (!client) {
        client = new OpenAI({
            ...
            defaultHeaders: {
                'HTTP-Referer': 'https://pagoexpress.vercel.app',
                'X-Title': 'PagoExpress Chatbot',
            },
        });
    }
    return client;
...
/**
 * Chat with OpenRouter (fallback LLM).
 * Uses meta-llama/llama-3.3-70b-instruct as default model.
 */
