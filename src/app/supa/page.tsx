...
// Official SUPA / Consejo de la Judicatura Colors
const SUPA_NAVY = "#003366"; // Dark Blue
const SUPA_CYAN = "#00AEEF"; // Official Cyan
...
export default function SupaPage() {
    ...
    const handleWhatsAppSubmit = async (e?: React.FormEvent) => {
        ...
        if (receipt) {
            try {
                ...
                formData.append("amount", quotas); // Using quotas as "amount" for metadata
    ...
    // FAQ - Preguntas Legales Frecuentes
    const faqs = [
        {
    ...
    return (
        <main className="min-h-screen bg-white text-slate-800 selection:bg-cyan-500 selection:text-white">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden bg-slate-50">
                {/* Background Decorators - REMOVED DOTS AS REQUESTED */}
                <div className="absolute inset-0 z-0 pointer-events-none opacity-40">
                    {/* Dots background was here */}
                </div>
            ...
            {/* ═══ SECCIÓN 2: Información Requerida para tu Pago ═══ */}
