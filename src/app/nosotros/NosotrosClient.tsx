            ...
            <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-pe-black text-white">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
                    <motion.div initial="hidden" animate="visible" variants={fadeUp}>
                        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-[5rem] font-black mb-6 leading-[1.2] lg:leading-[1.1] px-2">
                            19 años uniendo a <span className="text-pe-yellow">Ecuador</span> con el mundo
                        </h1>
                        <p className="text-base sm:text-xl text-white/80 max-w-3xl mx-auto mb-10 lg:mb-12 leading-relaxed font-medium px-4">
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
                        ...
                        <div className="relative w-full aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-pe-yellow bg-pe-gray-50 max-w-md mx-auto lg:ml-auto lg:mr-0 z-20">
                            <Image
            ...
            <section className="py-24 bg-pe-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="grid lg:grid-cols-3 gap-8">
                        <motion.div whileHover={{ y: -5 }} className="lg:col-span-2 p-10 rounded-[2.5rem] bg-pe-black text-white relative overflow-hidden group shadow-2xl">
                        ...
                        <motion.div whileHover={{ y: -5 }} className="p-10 rounded-[2.5rem] bg-white border border-pe-gray-200 text-pe-black relative overflow-hidden group shadow-sm">
                        ...
                        <div className="lg:col-span-3 p-8 lg:p-10 rounded-[2rem] lg:rounded-[2.5rem] bg-white border border-pe-gray-200 text-pe-black shadow-sm">
                    ...
                    <div className="relative flex overflow-hidden group">
                        <div className="flex gap-12 lg:gap-24 items-center animate-infinite-scroll py-8">
                            {infiniteAlliances.map((alliance, idx) => (
                                <div key={`${alliance.name}-${idx}`} className="flex-shrink-0 grayscale opacity-40 hover:opacity-100 hover:grayscale-0 transition-all duration-300">
                                    <Image src={alliance.logo} alt={alliance.name} width={160} height={80} className="h-10 lg:h-12 w-auto object-contain" />
                                </div>
                            ))}
                        </div>
                    </div>
