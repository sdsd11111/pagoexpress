...
export default function RecargasClient() {
    ...
    const brandConfig: Record<string, any> = {
        ...
        "Movistar": { divider: "bg-[#019DF4]", logoText: <div className="relative w-16 h-6 mx-auto"><Image src="/images/recargas/movistar 2.webp" alt="Movistar" fill className="object-contain" /></div>, logoColor: "text-[#019DF4]", defaultPill: "bg-[#8cc63f] text-white" },
        ...
        "Tuenti": { divider: "bg-[#ff0066]", logoText: <div className="relative w-14 h-6 mx-auto"><Image src="/images/recargas/tuenti 2.webp" alt="Tuenti" fill className="object-contain" /></div>, logoColor: "text-[#ff0066]", defaultPill: "bg-[#E5E7EB] text-gray-800" },
    ...
    const heroImages = [
        ...
        "/images/recargas/movistar 2.webp",
        "/images/recargas/tuenti 2.webp",
    ...
    const dynamicProviders = {
        celulares: [
            ...
            { name: "Movistar", type: "celulares", logo: "/images/recargas/movistar 2.webp", color: "text-green-500" },
            { name: "Tuenti", type: "celulares", logo: "/images/recargas/tuenti 2.webp", color: "text-pink-500" },
