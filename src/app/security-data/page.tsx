...
export default function SecurityDataPage() {
    ...
    const workflow = [
        {
            ...
            desc: "Verificamos tus requisitos físicos e identidad mediante controles biométricos de seguridad.",
            step: "1",
            icon: FileCheck
        },
        {
            title: "Pago de Servicios",
            desc: "Realiza el pago correspondiente en nuestro punto autorizado mediante efectivo o transferencia.",
            step: "2",
            icon: Stamp
        },
        {
            title: "Emisión y Entrega",
            desc: "Emitimos el certificado y lo enviamos a tu correo, o lo configuramos en tu dispositivo físico (Token).",
            step: "3",
            icon: Zap
        }
    ];
    ...
    const benefits = [
        {
            title: "Máxima Seguridad Legal",
            desc: "Respaldado por la Ley de Comercio Electrónico de Ecuador, otorgando total validez jurídica a tus documentos.",
            icon: Scale
        },
        {
            title: "Asistencia Técnica Personalizada",
            desc: "Te guiamos paso a paso en la instalación y configuración inicial de tus firmas en tus propios equipos.",
            icon: Cpu
        },
        {
            title: "Agilidad en Entregas",
            desc: "En nuestro punto autorizado PagoExpress gestionamos tu solicitud en el menor tiempo posible.",
            icon: Zap
        }
    ];
