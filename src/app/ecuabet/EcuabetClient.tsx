                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="text-center lg:text-left flex flex-col items-center lg:items-start">
                            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full border mb-8 bg-white/5 border-white/10">
                                ...
                                <Image src="/logo.jpg" alt="PagoExpress - Punto Autorizado Ecuabet en Loja" width={70} height={20} className="h-3.5 w-auto brightness-0 invert opacity-60" />
                            </div>
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    <Image 
                                        ...
                                        alt="Recargas Ecuabet y Retiros Ecuabet - PagoExpress Punto Oficial"
                                        fill
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        >
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                variants={sweepRight}
                                className="relative bg-black p-10 rounded-[2.5rem] border border-white/5 group-hover:border-pe-yellow/30 transition-all overflow-hidden h-full cursor-pointer active:scale-[0.98] flex flex-col"
                            >
                                ...
                                <div className="space-y-6 flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto flex items-center gap-3 p-4 bg-white/5 rounded-2xl border border-white/5 group-hover:bg-white/10 transition-all">
                        ...
                        >
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                variants={sweepRight}
                                className="relative bg-[#0D131A] p-10 rounded-[2.5rem] border border-white/5 group-hover:border-pe-yellow/30 transition-all overflow-hidden h-full cursor-pointer active:scale-[0.98] flex flex-col"
                            >
                                ...
                                <div className="space-y-6 flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto flex items-center gap-3 p-4 bg-pe-yellow/10 rounded-2xl border border-pe-yellow/20 group-hover:bg-pe-yellow/20 transition-all">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
                    ...
                    >
                        ...
                        <div className="text-center mb-10 mt-4">
                            ...
                            <p className="text-white/40 text-sm font-medium tracking-wide uppercase">Paso {step - 1} de {formType === "recharge" ? 4 : 5}</p>
                        </div>
                        ...
                        <div className="bg-neutral-900 border border-white/5 rounded-[2.5rem] p-8 sm:p-12 shadow-2xl relative overflow-hidden">
                            <div className="flex justify-between items-center mb-10">
                                {(formType === "recharge" ? [2, 3, 4, 5] : [2, 3, 4, 5, 6]).map((s) => (
                                    <div key={s} className="flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-[8px] sm:text-[10px] uppercase tracking-widest font-black opacity-30 text-center">
                                            {s === 2 ? (formType === "recharge" ? "Monto" : "Retiro") : s === 3 ? "Recibo" : s === 4 ? (formType === "recharge" ? "Resumen" : "Pago") : s === 5 ? (formType === "recharge" ? "Final" : "Resumen") : "Final"}
                                        </span>
                                    </div>
                                ))}
                            </div>
                            ...
                            {step === 2 && (
                                <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                                    <h3 className="text-2xl font-black uppercase italic" style={{ color: ECUABET_GOLD }}>
                                        {formType === "recharge" ? "Monto e ID" : "INGRESA LOS DATOS DE TU NOTA DE RETIRO"}
                                    </h3>
                            ...
                            {step === 3 && (
                                <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                                    <h3 className="text-2xl font-black uppercase italic" style={{ color: ECUABET_GOLD }}>{formType === "recharge" ? "Comprobante" : "CAPTURA DE NOTA DE RETIRO"}</h3>
                                    ...
                                    {formType === "recharge" ? (
                                        <div className="space-y-6">
                                            <div className="grid md:grid-cols-2 gap-6 items-stretch">
                                                <div className="bg-pe-yellow/5 border border-pe-yellow/20 rounded-2xl p-6 flex flex-col justify-center space-y-4 h-full">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <Banknote className="w-5 h-5 text-pe-yellow" />
                                                        <span className="text-xs font-black uppercase tracking-widest text-pe-yellow">Cuentas para depósito/transferencia</span>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-2 text-[10px] sm:text-xs font-medium text-white/70">
                                                        <div className="bg-white/5 p-3 rounded-lg">🏦 Produbanco: <span className="text-white">02125012701</span></div>
                                                        <div className="bg-white/5 p-3 rounded-lg">🏦 Pichincha: <span className="text-white">3472909404</span></div>
                                                        <div className="bg-white/5 p-3 rounded-lg">🏦 Guayaquil: <span className="text-white">21026425</span></div>
                                                        <div className="bg-white/5 p-3 rounded-lg">🏦 Banco Loja: <span className="text-white">2903772441</span></div>
                                                        <div className="bg-white/5 p-3 rounded-lg">🏦 CoopMego: <span className="text-white">401010139960</span></div>
                                                        <div className="bg-white/5 p-3 rounded-lg">🏦 JEP: <span className="text-white">406089279905</span></div>
                                                    </div>
                                                    <div className="pt-3 border-t border-pe-yellow/10">
                                                        <p className="text-[10px] sm:text-xs text-white/50 leading-relaxed">
                                                            👤 Titular: <strong className="text-white/80">César Augusto Amay Ríos</strong><br />
                                                            🪪 CI: <strong className="text-white/80">1103677546</strong> | 📧 info@pagoexpressec.com
                                                        </p>
                                                    </div>
                                                </div>

                                                <div 
                                                    className={`h-full border-2 border-dashed rounded-[2rem] p-6 flex flex-col items-center justify-center gap-4 transition-all cursor-pointer ${
                                            ...
                                            <div className="bg-white/5 rounded-2xl p-5 sm:p-6 border border-white/10 text-xs sm:text-sm text-white/80 space-y-3">
                                                <p className="font-black text-pe-yellow uppercase tracking-widest text-sm flex items-center gap-2">
                                                    ⚠️ Importante
                                                </p>
                                                <div className="space-y-2 text-white/70">
                                                    <p className="flex items-start gap-2">
                                                        <span className="text-green-400">✅</span> Realiza la transferencia de banco a banco.
                                                    </p>
                                                    <p className="flex items-start gap-2">
                                                        <span className="text-red-400">❗</span> 
                                                        <span>Si no tienes cuenta en los bancos listados, deposita en <strong className="text-white font-bold">Produbanco</strong> y haz una interbancaria en línea o pago directo.</span>
                                                    </p>
                                                    <p className="flex items-start gap-2">
                                                        <span>⏳</span> De lo contrario, el pago puede tardar hasta 48 horas en acreditarse.
                                                    </p>
                                                </div>
                                                <div className="h-px bg-white/10 w-full my-4"></div>
                                                <p className="font-bold text-white flex items-center gap-2">
                                                    <span className="text-green-400">✅</span> Una vez confirmado el pago, se procesará tu solicitud.
                                                </p>
                                            </div>
                                        </div>
                                    ) : (
                                        ...
                                        <div className="text-center space-y-8 py-8">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <p className="text-white/60 text-sm font-medium max-w-xs mx-auto">
                                                    Hemos recibido tus datos correctamente. El tiempo de acreditación es de aproximadamente <span className="text-white font-bold">10 minutos ⏳</span>.
                                                </p>
                                            </div>

                                            <button 
                                                onClick={() => { setStep(2); setReceipt(null); setReceiptUrl(""); }}
                            ...
                            {step === 6 && formType === "withdraw" && (
                                <motion.div key="step6" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center space-y-8 py-8">
                                    ...
                                    <button 
                                        onClick={() => { setStep(2); setReceipt(null); setReceiptUrl(""); setBankName(""); setAccountNumber(""); setAccountType(""); }}
                                        className="py-4 px-10 border border-white/10 hover:border-white/30 text-white/50 hover:text-white text-[10px] font-black uppercase tracking-widest transition-all rounded-2xl flex items-center justify-center gap-2 mx-auto"
                                    >
                                        <RefreshCcw className="w-3 h-3" /> Realizar otra solicitud
                                    </button>
